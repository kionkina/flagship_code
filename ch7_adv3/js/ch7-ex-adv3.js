...
for (var i=0; i<term_array.length/2; i++){
	...
	terms1.innerHTML += "<tr><td style='text-align: right'  width='20px'><a  class='mark_ex6' href='#'>&#10008;</a><a  class='mark_correct_ex6' href='#'>&#10004;</a></td><td> <div class='e5_width font_kai'>" + "<font color='#484848'>" + (i+1) +  "</font>&nbsp;&nbsp;&nbsp; " +  term_array[i] +"</div></td><td><input type='text' class='answer_input' id='" + i + "'></input></td></tr>";
...
for (var i=term_array.length/2; i<term_array.length; i++){
	...
	terms2.innerHTML += "<tr><td style='text-align: right'  width='20px'><a class='mark_ex6' href='#'>&#10008;</a><a class='mark_correct_ex6' href='#'>&#10004;</a></td><td> <div class='e5_width font_kai'>" + "<font color='#484848'>" + (i+1) +  "</font>&nbsp;&nbsp;&nbsp; " +  term_array[i]  + 
	 "</div></td><td><input type='text' class='answer_input'></input></td></tr>";
